...
public class MapScript : MonoBehaviour
{
    ...
    public bool QueryTilePassability(int x, int z)
    {
        ...
        {
            if (tiles[x - tileOffsetX, z - tileOffsetZ].type == TileType.Finish)
    ...
    public TileType QueryTileType(int x, int z)
    {
        return tiles[x - tileOffsetX, z - tileOffsetZ].type;
    }
    ...
    private void RandomLandMines()
    {
        ...
        for (int numberOfMines = 0; numberOfMines < numOfRandMines; )
        {
            ...
            if (tiles[xLoc, yLoc].type == TileType.Normal)
            {
                tiles[xLoc, yLoc].type = TileType.Landmine;
                ++numberOfMines;
            }
        }
    }
